...
public class ProducerConfirmAsync {
    ...
    public static void main(String[] args) throws IOException, TimeoutException, InterruptedException {
        ...
        //TODO
        // 添加发送者确认监听器，channel.basicPublish发送到exchange中去，但不一定会发送到queue
        // producer生产消息，发送到是rabbitmq中的exchange，rabbitmq的exchange内部将message发送到queue中去
        channel.addConfirmListener(new ConfirmListener() {
            ...
            public void handleNack(long deliveryTag, boolean multiple)
                    throws IOException {
                //multiple--true 为批量，multiple--false--单条|一般
                System.out.println("Erro----send_NACK:" + deliveryTag + ",multiple:" + multiple);
            }
        });

        //TODO
        // 添加失败者通知，就是这个message没有发到任何一个queue
